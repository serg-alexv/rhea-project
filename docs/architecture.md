...
**Model assignment logic:** Reasoning-heavy (science, culture, critique) → Opus 4. Execution-heavy (UX, code, growth) → Sonnet 4.
...
**Tribunal mode:** 5 independent model responses on same question → compare perspectives.
