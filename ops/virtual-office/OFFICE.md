...
3. Every external insight (ChatGPT, web, bridge) goes to GEMS.md immediately
4. Every broken thing goes to INCIDENTS.md immediately
5. Every decision goes to DECISIONS.md with "why" and "who decided"
6. Git push at least every 30 minutes
...
- Git is the audit trail. If it is not committed, it did not happen.

## Inbox/Outbox SLA
- Inbox items processed by LEAD within 1 hour of discovery
- Outbox tasks acknowledged by target desk within 2 hours
- Stale items (> 4 h unprocessed) auto-escalate to INCIDENTS
...
- Every session MUST end with at least 1 artifact in inbox:
