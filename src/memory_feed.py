...
def generate_feed() -> str:
    ...
    lines = [
        ...
        "  genesis: ChatGPT chat eb53e82c → 'преимущества григорианского календаря' → 42 systems → health → ADHD → 8 agents",
        "  Rhea = titan goddess who tricked Time (Kronos) to save the future",
