...
4. **Use Cases (Start Here):**
   Open [docs/ui/START_HERE_PLAYBOOK.md](docs/ui/START_HERE_PLAYBOOK.md) for executable role-based flows
   (`biochemist`, `operator`, `investor`) with evidence checks.
